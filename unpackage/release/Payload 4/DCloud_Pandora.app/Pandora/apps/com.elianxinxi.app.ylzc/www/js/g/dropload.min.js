...
function(a) {
	...
	a.fn.dropload = function(a) {
		...
		var d = this;
		d.$element = a(b), d.upInsertDOM = !1, d.loading = !1, d.isLock = !1, d.isData = !0, d._scrollTop = 0, d.init(c)
		...
		k.opts = a.extend({}, {
			...
			loadUpFn: "",
			loadDownFn: ""
		}, f), "" != k.opts.loadDownFn && (k.$element.append('<div class="' + k.opts.domDown.domClass + '">' + k.opts.domDown.domRefresh + "</div>"), k.$domDown = a("." + k.opts.domDown.domClass)), k.opts.scrollArea == b ? (k.$scrollArea = d, k._scrollContentHeight = e.height(), k._scrollWindowHeight = c.documentElement.clientHeight) : (k.$scrollArea = k.opts.scrollArea, k._scrollContentHeight = k.$element[0].scrollHeight, k._scrollWindowHeight = k.$element.height()), d.on("resize", function() {
			k._scrollWindowHeight = k.opts.scrollArea == b ? b.innerHeight : k.$element.height()
		}), k.$element.on("touchstart", function(a) {
			k.loading || k.isLock || (g(a), h(a, k))
		}), k.$element.on("touchmove", function(a) {
			k.loading || k.isLock || (g(a, k), i(a, k))
		}), k.$element.on("touchend", function() {
			k.loading || k.isLock || j(k)
		}), k.$scrollArea.on("scroll", function() {
			k._scrollTop = k.$scrollArea.scrollTop(), k._threshold = "" === k.opts.threshold ? Math.floor(1 * k.$domDown.height() / 3) : k.opts.threshold, "" != k.opts.loadDownFn && !k.loading && !k.isLock && k._scrollContentHeight - k._threshold <= k._scrollWindowHeight + k._scrollTop && (k.direction = "up", k.$domDown.html(k.opts.domDown.domLoad), k.loading = !0, k.opts.loadDownFn(k))
		})
